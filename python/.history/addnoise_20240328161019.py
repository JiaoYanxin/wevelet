...
# 读取原始 MRC 文件
input_file_path="/data/重建数据集/deepdewadge/model0/projodd.mrc"
output_file_path="/home/jiaoyx/Downloads/DeepDeWedge/tutorial_data/tutorial_data/projodd_noisy.mrc"
